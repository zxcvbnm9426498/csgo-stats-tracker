        ...
        <div className="p-4 flex flex-col h-full">
          ...
          <nav className="flex-1">
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/admin/user-login" className="flex items-center px-4 py-3 hover:bg-gray-700 rounded transition-colors">
              ...
              <li>
                <Link href="/admin/database" className="flex items-center px-4 py-3 hover:bg-gray-700 rounded transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
